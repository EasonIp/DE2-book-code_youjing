...
# File: DE2_115_Default.tcl
# Generated on: Tue Aug 01 18:36:29 2017
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "DE2_115_Default"]} {
		puts "Project DE2_115_Default is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists DE2_115_Default]} {
		project_open -revision DE2_115_Default DE2_115_Default
	} else {
		project_new -revision DE2_115_Default DE2_115_Default
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "09:10:21  MARCH 29, 2010"
	...
	set_global_assignment -name VERILOG_FILE V/VGA_Audio_PLL.v
	...
	set_global_assignment -name VERILOG_FILE V/LCD.V
	...
	set_global_assignment -name SDC_FILE de2_115_default.SDC
	set_global_assignment -name VERILOG_FILE DE2_115_Default.v
	set_global_assignment -name MISC_FILE DE2_115_Default.dpf
